...
/**
 * The `PredominantStylePerIntervenant` command determines the predominant style
 * based on the know invtervenants.
 * 
 ...
 * `cities`, `streets`, `typologies`, `styles` & `intervenants`
 * 
 * @internal
*/
